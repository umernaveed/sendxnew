...
class Setting {
  ...
  @JsonKey(name: 'mobile_cache_version')
  final String? mobileCacheVersion;
  ...
  Setting copyWith({
    ...
    return Setting(
      ...
      mobileCacheVersion: mobileCacheVersion ?? this.mobileCacheVersion,
    );
  }
